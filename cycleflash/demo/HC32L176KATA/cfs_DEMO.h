 ...
 *
 * Write an entry to the *Identity* NV file system.
 *
 * @param[in] id Id of the entry to be written
 * @param[in] data Pointer to the data to be written
 * @param[in] len Number of bytes to be written
 ...
 *
 * Read an entry from the *Nexus* NV file system.
 *
 * @param[in] id Id of the entry to be read
 * @param[out] data Pointer to data buffer
 * @param[in] len Number of bytes to be read
 ...
 *
 * Read an entry from the *Identity* NV file system.
 *
 * @param[in] id Id of the entry to be read
 * @param[out] data Pointer to data buffer
 * @param[in] len Number of bytes to be read
...
/**
 * @brief flash_filesystem_erase_identity_nv
 *
 * Erase all data from the Identity NV partition (ID、secret Key).
 *
 * Can be used to 'reset' the device Identity state in testing.
 *
 * @retval -ERRNO errno code if error
 */
